...
node = {
    ...
    "SolNode715": "Effervo, Albrecht's Laboratories",
    "SolNode716": "Nex, Albrecht's Laboratories",
    "SolNode717": "Persto, Albrecht's Laboratories",
    "SolNode718": "Cambire, Albrecht's Laboratories",
...
exclusive_weapons = {
    "/Lotus/Weapons/Tenno/Bow/LotusBow": "Bows (Primary)",
    "/Lotus/Weapons/Tenno/Melee/LotusMelee": "Melee",
    "/Lotus/Weapons/Tenno/Pistol/LotusPistol": "Pistols (Secondary)",
    "/Lotus/Weapons/Tenno/Rifle/LotusRifle": "Rifles (Primary)",
    "/Lotus/Weapons/Tenno/Shotgun/LotusShotgun": "Shotguns (Primary)",
}
